...
public enum GlobalStatus {
    ...
    IN_TRANSIT_TO_SORTING("В пути на сортировку", "<i class=\"bi bi-truck\" style=\"font-size: 2rem; color: #0000FF\"></i>"),
    IN_TRANSIT_TO_DELIVERY("В пути к ОПС назначения", "<i class=\"bi bi-truck\" style=\"font-size: 2rem; color: #0000FF\"></i>"),
    ...
    RETURN_IN_TRANSIT_TO_SORTING("Возврат на сортировку", "<i class=\"bi bi-truck\" style=\"font-size: 2rem; color: #FF0000; transform: scaleX(-1)\"></i>"),
    RETURN_IN_TRANSIT_TO_SENDER("Возврат в пути к отправителю", "<i class=\"bi bi-truck\" style=\"font-size: 2rem; color: #FF0000; transform: scaleX(-1)\"></i>"),
