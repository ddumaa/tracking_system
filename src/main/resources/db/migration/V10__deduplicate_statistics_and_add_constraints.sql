...
ALTER TABLE tb_store_statistics
    ADD CONSTRAINT IF NOT EXISTS uk_store_statistics_store UNIQUE (store_id);

ALTER TABLE tb_postal_service_statistics
    ADD CONSTRAINT IF NOT EXISTS uk_postal_stats_store_service UNIQUE (store_id, postal_service_type);
