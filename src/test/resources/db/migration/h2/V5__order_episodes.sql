...
ALTER TABLE tb_track_parcels
    ADD COLUMN IF NOT EXISTS episode_id BIGINT NOT NULL REFERENCES tb_order_episodes (id) ON DELETE RESTRICT,
    ADD COLUMN IF NOT EXISTS exchange BOOLEAN NOT NULL DEFAULT FALSE,
    ADD COLUMN IF NOT EXISTS replacement_of_id BIGINT REFERENCES tb_track_parcels (id) ON DELETE SET NULL;
